...
if __name__ == "__main__":
    ...
    source = '/kaggle/input/ravir-data-preprocessed/final_data'

    dataset_name = 'Dataset020_Ravir'
    ...
    generate_dataset_json(join(nnUNet_raw, dataset_name), {0: 'R', 1: 'G', 2: 'B'}, {'background': 0, 'artery': 1,'viens':2},
